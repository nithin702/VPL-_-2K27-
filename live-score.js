...
document.getElementById("btn0").onclick = ()=>scoreBall(0);
document.getElementById("btn1").onclick = ()=>scoreBall(1);
document.getElementById("btn2").onclick = ()=>scoreBall(2);
document.getElementById("btn3").onclick = ()=>scoreBall(3);
document.getElementById("btn4").onclick = ()=>scoreBall(4);
document.getElementById("btn6").onclick = ()=>scoreBall(6);

// =====================================================
// NORMAL BALL
// =====================================================

function scoreBall(run){
    ...
    if(run===4) strikerStats.fours++;

    if(run===6) strikerStats.sixes++;
...
function updateScoreBoard(){
    ...
    currentOvers===0
    ? "0.00"
    : (totalRuns/currentOvers).toFixed(2);
    ...
    ? "0.00"
    : ((strikerStats.runs/strikerStats.balls)*100).toFixed(2);
