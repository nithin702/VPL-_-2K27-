...
const verifiedPlayers=document.getElementById("verifiedPlayers");
...
verifiedPlayers.innerHTML=`✅ Verified : ${verifiedCount}`;
pendingPlayers.innerHTML=`🟡 Pending : ${pendingCount}`;
...
<span style="color:${player.paymentStatus==="Verified"?"lime":"orange"};font-weight:bold;">
...
`<button
style="background:green;color:white;border:none;padding:8px 15px;border-radius:6px;">
✅ Verified
</button>`
...
`<button
onclick="verifyPayment('${player.id}')"
